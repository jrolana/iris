  ...
  return (
    <div className="border-slate-200 bg-white p-2">
      ...
      {isLeaf && currentNode.result ? (
        <div className="mt-2 rounded-lg border border-emerald-100 bg-emerald-50 p-4">
          <p className="text-md font-medium uppercase tracking-wide text-emerald-700">
            Recommended Disclosure Form
          </p>
          <p className="mt-1 text-md font-semibold text-emerald-900">
            {currentNode.result.formName}
          </p>
          <p className="mt-2 text-md text-emerald-900">
          ...
          {currentNode.options?.map((option: WizardOption) => {
            ...
            return (
              ...
              >
                ...
                {option.description && (
                  <span className="mt-1 text-md text-slate-600">
                    {option.description}
                  </span>
                )}
              </button>
