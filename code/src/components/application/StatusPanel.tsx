...
export default function StatusHistoryPanel(props: StatusHistoryPanelProps){
    ...
    if (!statuses || statuses.length === 0) {
        ...
        <div
            className={
            'rounded-2xl border border-slate-200 bg-white p-4 text-slate-500 ' +
            className
            }
        >
    ...
    return (
        <div
        className={
            'rounded-2xl border border-slate-200 bg-white p-4 text-slate-700 shadow-sm ' +
            className
        }
        >
                ...
                return (
                    <div
                        ...
                        className={clsx(
                            ...
                            isCurrent ? 'border-sky-500 border-2 bg-sky-50' : 'border-slate-100 bg-slate-50',
                        )}
                    >
