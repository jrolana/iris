...
export default function SignInForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    console.log("Redirect URL:", `${window.location.origin}/signin/callback`);
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
      ...
      <div className="grid grid-cols-2">
        <button
          className="col-span-2 inline-flex items-center justify-center gap-3 rounded-lg bg-gray-100 px-7 py-3 text-sm font-normal text-gray-700 transition-colors hover:bg-gray-200 hover:text-gray-800 sm:col-span-1"
