...
export type Database = {
  ...
  private: {
    ...
    Functions: {
      ...
      log_audit_event: {
        Args: {
          p_action_result: Database["private"]["Enums"]["actionresult"]
          p_action_taken: string
          p_action_type: Database["private"]["Enums"]["actiontype"]
          p_actor_user_id?: string
          p_changed_fields?: Json
          p_fallback_user_name?: string
          p_fallback_user_role?: string
          p_record_type: Database["private"]["Enums"]["recordtype"]
          p_snapshot_record_reference: string
        }
        Returns: string
      }
