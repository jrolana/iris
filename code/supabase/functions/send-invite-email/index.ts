  ...
  try {
    ...
    const info = await transporter.sendMail({
      ...
      text: [
        `Dear ${recipientName},`,
        "",
        `You have been invited to access IRIS - Information Rights Information System as a ${roleLabel}.`,
        "",
              ...
              <tr>
                <td align="center" style="padding:40px 16px;">
                  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background:#ffffff; border-radius:8px; padding:32px; border:1px solid #e5e7eb;">
                    ...
                    <tr>
                      <td style="font-size:15px; color:#374151; line-height:1.6; padding-bottom:16px;">
                        You have been invited to access <strong>IRIS - Information Rights Information System</strong> as a ${safeAssignedRole}.
