...
For example, \figref{fig:test} shows a graph of the performance of Disney stock from the 1980s to 2012.
...
\begin{figure}[h]                %-- use [t] to place figure at top, [b] to place at the bottom, [h] for here
   \centering                    %-- use this to center the figure
   \includegraphics[scale=0.5]{general_sequenceA.png}      %-- include image file named as "disneychart.png" 
   \caption{TM, UM/ID, Patent Application Sequence Diagram}
    \label{fig:test}
\end{figure}
