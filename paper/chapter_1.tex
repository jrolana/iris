...
This study aims to design, develop, and evaluate IRIS, a web-based system that eliminates manual IP application tracking inefficiencies, enhance transparency through status monitoring, offer a standardized platform for Technology Generators regarding IPR application-related processes, and provide comprehensive analytics for improved decision-making in IP management and output in the university.
