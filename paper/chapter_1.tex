...
This study aimed to design, develop, and evaluate IRIS, a web-based system that eliminated manual IP application tracking inefficiencies, enhanced transparency through status monitoring, offered a standardized platform for Technology Generators regarding IPR application-related processes, and provided comprehensive analytics for improved decision-making in IP management and output in the university.

The research output was a fully functional, secure, and scalable IRIS with role-based access control, application status tracking, automated notification systems, dashboards, and public portals for published IP applications. Its system architecture was designed to be scalable for potential adaptation by other UP constituent universities. It was evaluated through usability testing, penetration testing, and end-to-end testing.

\subsection{Specific Objectives}

To accomplish the general objective of developing the system within the academic year 2025--2026, the specific objectives were to:
...
\begin{enumerate}
  ...
  \item evaluate the system through usability testing, penetration testing, and end-to-end testing and document the development process, design, and evaluation results to support replicability for other UP constituent universities.
\end{enumerate}

\section{Scope and Limitations of the Research}

The system was developed and evaluated within the academic year 2025--2026. It encompasses four user roles, namely TTBDO Admins, Technology Generators, UP Officials, and Guests. Core features include user management, timestamped application tracking, dashboard analytics, automated notifications, digital submissions, guided IP-type selection, disclosure form and application-related document submission, document and attachment management, and a public portal for published IP applications.
